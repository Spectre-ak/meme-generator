...
class ImageComponent extends React.Component {
  constructor(props) {
    ...
    this.onEditingDone=this.onEditingDone.bind(this);
  ...
  componentDidMount() {
    ...
    this.setState({
      data: data,
      imgUrl: data["data"]["memes"][Math.floor(Math.random() * data["data"]["memes"].length)].url
    });
  }
  onMouseDown(e){
    console.log(e);
    ...
    textFields.push(<TextInput x={e.pageX} y={e.pageY} key={Math.random()}/>);
    console.log(textFields);
    this.setState({
  ...
  onBackgroundColorChange(){
    document.querySelector('.meme-img-container').style.background=document.querySelector('#background-color').value;
  }
  ...
  onEditingDone(){
    ...
    document.querySelectorAll('#input-controls').forEach(ele=>{
  ...
  onTextColorChange(){
    document.querySelectorAll('textarea').forEach(ele=>{
      ele.style.color=document.querySelector('#text-color').value;
    });
  }
    ...
    return (
      <React.Fragment>
        <div className='container'>
          <h4>Welcome to MEME Generator</h4>
          <p>Click on image to insert captions and click Done <i class="fa fa-check" aria-hidden="true"></i> at bottom once finished editing.</p>
          <div className='meme-img-container' onMouseDown={this.onMouseDown}>
          ...
          <div class="form-row align-items-center">
            <div class="col-sm-3 my-1">
              <label class="sr-only" for="inlineFormInputName">background-color</label>
              <input type="text" class="form-control" id="background-color" placeholder="Black..."/>
            </div>
            <div class="col-auto my-1">
              <button type="submit" class="btn btn-primary" onClick={this.onBackgroundColorChange}>Change background color</button>
            </div>
            
            <div class="col-sm-3 my-1">
              <label class="sr-only" for="inlineFormInputName1">text-color</label>
              <input type="text" class="form-control" id="text-color" placeholder="#007bff..."/>
            </div>
            <div class="col-auto my-1">
              <button type="submit" class="btn btn-primary" onClick={this.onTextColorChange}>Change text color</button>
            </div>

            <button type="button" class="btn btn-success" onClick={this.onEditingDone}>Done &nbsp;<i class="fa fa-check" aria-hidden="true"></i></button>
          </div>
